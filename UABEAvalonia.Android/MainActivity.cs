...
namespace UABEAvalonia.Android
{
    ...
    public class MainActivity : Activity
    {
            ...
            string fileName)
        {
            ...
            // FIX:
            // DirectoryInfos.Count adalah method.
            // Gunakan Count().
            int directoryCount =
                directories.Count();
            ...
            try
            {
                    ...
                    encodedData.Length == 0)
                {
                    throw new Exception(
                        ...
                        "atau data texture belum tersedia.");
                }
            ...
            int height)
        {
            ...
            {
                throw new Exception(
                    "Texture terlalu besar untuk Bitmap Android.");
            }
